...
# Simple test script for Hashcat -I Parsing
echo "🧪 Simple Hashcat -I Parsing Test"
echo "=================================="
...
if command -v hashcat &> /dev/null; then
    ...
    echo "   This test requires hashcat to be installed"
    exit 1
fi

# Test 2: Run hashcat -I and capture output
echo ""
echo "📝 Test 2: Run hashcat -I and parse output"
echo "-------------------------------------------"
...
echo ""
echo "❓ If agent still returns 'GPU' when hashcat shows 'CPU':"
echo "1. Check if agent is actually running hashcat -I"
echo "2. Check if parsing is working correctly"
echo "3. Check if fallback detection is being triggered"
echo "4. Check agent logs for detailed information"
